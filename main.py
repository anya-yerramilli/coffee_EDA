...
st.write('1. We believe that the different factors used in the process of creating coffee affect the coffee\'s final aroma, flavor, aftertaste, and acidity.')
st.write('2. We believe that the natural/dry method of processing coffee will be the most popular and best method of producing coffee.')
st.markdown("---")
...
st.pyplot(fig)
st.write('In almost every coffee growing country, farms use the washed/wet, natural dry, and honey method. Countries with the best tasting coffee such as Colombia and Taiwan use numerous methods to grow their crops. Whereas in places such as Kenya and Uganda, these drier, less arable regions limit the amount of methods they can use to produce coffee.')
st.markdown("---")
